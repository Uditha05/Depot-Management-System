...
<body style="background: azure;">
  ...
  <h1 style="padding-left: 40%;">Remove/Edit Employee</h1>
  <div class="form-row col-md-12" style="margin-top: 34px;">
    <div class="col-md-6 mb-0 p-3 bg-warning" style="background-color: #adb5bd!important;">
      ...
      <form action="remove_employee.view.php" method="post">
      <div class="form-row">
      ...
      <div class="form-row">
        <div class="col-md-6 mb-4">
          <label for="validationDefault03">NIC</label>

          <input type="text" class="form-control" name="NIC" id="NIC" placeholder="NIC" required>
        </div>
      </div><!---second row-->
      <div class="button-group">
        <button class="btn btn-new" name="submit" type="submit"data-toggle="modal">Remove employee</button>
        <a class="btn btn-new" href="emplist.view.php" role="button">back</a>
      </div><!--button group-->
    ...
    <div class="col-md-6 p-3 bg-dark text-white" style="background-color: #5b5e60!important;">
      ...
      <form action="remove_employee.view.php" method="post"><!--Editing form--->
...
<?php
  if (isset($_POST['submit'])){
    ...
    $adminkObj->remove_employee($empid);
  ...
  if(isset($_POST['edit'])){
    ...
    $adminkObj->edit_employee($empid,$column,$value);//when press the edit butto to update column
  }
